...
export const LabelsPage = () => {
    ...
    let hostnameAsAliasError: string | null = null;
    if (aliasMode === AliasMode.HOSTNAME) {
        const hasError = validateLabelValue(model.hostname.value) !== null;
        hostnameAsAliasError = hasError ? _("The hostname is not a valid alias") : null;
    }
